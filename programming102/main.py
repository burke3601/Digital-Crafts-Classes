from pet import Pet, CuddlyPet # not sure if I needed to do this
...
def main():    #copied and pasted
    while True:
        ...
        if choice == 1:
            ...
            if type_choice == 1:
                pets.append(Pet(pet_name)) #still not sure why error ***had incorrect vlaues for methods FIXED
            elif type_choice == 2:
...
#         if choice == 1:
#             pet_name = input("What would you like to name your pet? ")
#             pets.append(Pet(pet_name)) #not sure why error...
#             print("You now have %d pets" % len(pets))
